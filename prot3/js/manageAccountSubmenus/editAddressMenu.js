function EditAddressMenu(address) {
	UpperMenu.call(this, "Editar morada");
	this.el.classList.add("editAddressMenu");
	...
	this.inputName.addEventListener("focusin", keyboardFocus);
	this.inputName.addEventListener("focusout", keyboardDefocus);
	
	this.inputName.type = "text";
	this.inputName.value = address.name;
	...
	this.inputLocal.addEventListener("focusin", keyboardFocus);
	this.inputLocal.addEventListener("focusout", keyboardDefocus);
	
	addrContainer.classList.add("addrContainer");
	this.inputLocal.type = "text";
	this.inputLocal.value = address.local;
