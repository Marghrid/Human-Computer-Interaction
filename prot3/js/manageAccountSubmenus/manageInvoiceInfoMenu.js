function ManageInvoiceInfoMenu() {
	...
	this.inputNIF.addEventListener("focusin", keyboardFocus);
	this.inputNIF.addEventListener("focusout", keyboardDefocus);
	...
	this.inputAddress.addEventListener("focusin", keyboardFocus);
	this.inputAddress.addEventListener("focusout", keyboardDefocus);
